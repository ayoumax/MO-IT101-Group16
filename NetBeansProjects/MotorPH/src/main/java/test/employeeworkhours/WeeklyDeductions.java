...
/**
 * Weekly Deductions Processor.
 * Reads salary details.
 * Computes government deductions (SSS, Pagibig, Philhealth).
 * Displays and exports the report.
 * 
...
public class WeeklyDeductions { 
    ...
    /**
     * Run method for Weekly Deductions processing.
     */
    public void run() { 
    ...
    public static void main(String[] args) { 
        ...
        System.out.println("🔍 Checking weekly hours file: " + hoursFile);
        System.out.println("Running Weekly Deductions...");
    ...
    private static List<Employee> readEmployeeData(String filePath) {
        ...
        try (FileInputStream fis = new FileInputStream(new File(filePath));
            ...
            System.err.println("❌ ERROR: Failed to read employee data.");
            e.printStackTrace();
        }
        return employees;
    }
    ...
    // * Display Weekly Deductions (Formatted table)
