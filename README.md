...
2️⃣ **Place `employee_data.txt` in the same directory as `EmployeePayrollProcessor.java`.  
3️⃣ **Compile and Run the Java Program:**

🤝 Collaborating on GitHub
If you want to add team members, follow these steps:

1️⃣ Go to GitHub → Your Repository → Settings → Collaborators.
2️⃣ Click "Add people", enter their GitHub username, and set their permissions.
3️⃣ The collaborator must accept the invitation via email or GitHub.
